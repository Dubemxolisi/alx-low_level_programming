 ...
 * Dexcription: if the file is not an ELF file - exit code 98
 */
 ...
 * @e_ident: its a pointer to an array contaning the ELF class
 */
...
/**
 * orint_type - it prints the type of an ELF header
 * @e_ident: its a pointer to an array containining the ELF ABI Version
 */
 ...
 * @e_ident: its a pointer to an array that contain the ELF class
 */
 ...
 * @elf: its the descriptor of the ELF file
 ...
 * @argv: its an array of a ponter to the arguments
 * Return: 0 on success
